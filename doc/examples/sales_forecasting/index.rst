...
* **Run predictions (UDFs) with SQL queries**: Execute forecasts directly within Exasol using standard SQL, without moving data outside the database using :doc:`../../UDF/index`.
...
* A :doc:`UDF <../../UDF/index>` inside Exasol that encapsulates the model logic.
